(()=>{
  ...
  simplifyNavigation();
  style('./dashboard-v2.css');style('./shoot-flow.css');style('./learn.css');style('./review-flow.css');style('./reshoot.css');style('./smart-coach.css');style('./history.css');style('./native-ui.css');style('./shoot-v2.css');style('./review-v2.css');style('./editor-v2.css');
