// V49 focus-first Guided Shoot setup
const CACHE='canon-t7-studio-v49';
const CORE=['./','./index.html','./styles.css','./dashboard.css','./router.css','./router.js','./store.js','./photo-session.js','./native-ui.css','./native-ui.js','./home-coach.css','./photo-visual.css','./photo-content.css','./studio-finishing.css','./motion-v1.css','./motion-v1.js','./polish-v2.css','./polish-v2.js','./app.js','./core.js','./camera-v2.css','./camera-v2.js','./t7-engine.js','./review-engine.js','./conditions.js','./conditions-v2.css','./conditions-v2.js','./editor.js','./editor-v2.css','./editor-v2.js','./shoot-flow.css','./shoot-v2.css','./shoot-focus.css','./shoot-focus.js','./scene-assist.css','./shoot-flow.js','./learn.css','./learn.js','./learn-v2.css','./learn-v2.js','./practice-coach.css','./practice-coach.js','./review-flow.css','./review-v2.css','./review-diagnostic.css','./review-flow.js','./review-v2.js','./reshoot.css','./reshoot.js','./smart-coach.css','./smart-coach.js','./history.js','./library.css','./library.js','./library-insights.css','./library-insights.js','./camera-steps.css','./camera-steps.js','./manifest.webmanifest'];
