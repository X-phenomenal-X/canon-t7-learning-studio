const CACHE='canon-t7-studio-v35';
const CORE=['./','./index.html','./styles.css','./dashboard.css','./router.css','./router.js','./store.js','./photo-session.js','./native-ui.css','./native-ui.js','./polish-v2.css','./polish-v2.js','./app.js','./core.js','./t7-engine.js','./review-engine.js','./conditions.js','./conditions-v2.css','./conditions-v2.js','./editor.js','./editor-v2.css','./editor-v2.js','./shoot-flow.css','./shoot-v2.css','./shoot-flow.js','./learn.css','./learn.js','./learn-v2.css','./learn-v2.js','./review-flow.css','./review-v2.css','./review-diagnostic.css','./review-flow.js','./review-v2.js','./reshoot.css','./reshoot.js','./smart-coach.css','./smart-coach.js','./history.js','./library.css','./library.js','./camera-steps.css','./camera-steps.js','./manifest.webmanifest'];
