const CACHE='canon-t7-studio-v10';
const CORE=['./','./index.html','./styles.css','./dashboard.css','./app.js','./core.js','./t7-engine.js','./conditions.js','./editor.js','./shoot-flow.css','./shoot-flow.js','./learn.css','./learn.js','./review-flow.css','./review-flow.js','./manifest.webmanifest'];
