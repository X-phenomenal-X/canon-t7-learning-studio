const CACHE='canon-t7-studio-v15';
const CORE=['./','./index.html','./styles.css','./dashboard.css','./app.js','./core.js','./t7-engine.js','./conditions.js','./editor.js','./shoot-flow.css','./shoot-flow.js','./learn.css','./learn.js','./review-flow.css','./review-flow.js','./reshoot.css','./reshoot.js','./smart-coach.css','./smart-coach.js','./history.css','./history.js','./manifest.webmanifest'];
